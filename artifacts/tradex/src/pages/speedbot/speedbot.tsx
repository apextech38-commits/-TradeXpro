...
const SpeedBot = observer(() => {
    ...
    const purchaseOnce = async () => {
        ...
        if (isSpecialCR) {
            ...
            const { token: demoToken } = getToken(); // This already returns demo token for special CR accounts
                ...
                <div className='speedbot__card'>
                    ...
                    <div className='speedbot__row speedbot__row--two speedbot__toggles'>
                        <div className='speedbot__toggle'>
                            <span className='speedbot__toggle-label'>{localize('Alternate Even and Odd')}</span>
                            <label className='switch'>
                                <input
                                    type='checkbox'
                                    aria-label={localize('Alternate Even and Odd')}
                                    checked={altEvenOdd}
                        ...
                        <div className='speedbot__toggle'>
                            <span className='speedbot__toggle-label'>{localize('Alternate on Loss')}</span>
                            <label className='switch'>
                                <input
                                    type='checkbox'
                                    aria-label={localize('Alternate on Loss')}
                                    checked={altOnLoss}
