    ...
    return (
        <div className='hybrid-bots'>
            <div className='hybrid-bots__cards-container'>
                <div
                    className={`hybrid-bots__card hybrid-bots__card--light ${
                        active_tool === 'diffbot' ? 'hybrid-bots__card--active' : ''
                    }`}
                ...
                <div
                    className={`hybrid-bots__card hybrid-bots__card--light ${
                        active_tool === 'hyperbot' ? 'hybrid-bots__card--active' : ''
                    }`}
                ...
                <div
                    className={`hybrid-bots__card hybrid-bots__card--light ${
                        active_tool === 'speedbot' ? 'hybrid-bots__card--active' : ''
                    }`}
