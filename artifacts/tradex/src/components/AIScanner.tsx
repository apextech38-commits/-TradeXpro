  ...
  return (
    <>
      ...
      >
        {/* Ambient glow */}
        <span
          className="absolute inset-0 rounded-full bg-gradient-to-br from-[#a78bfa] to-[#14b8a6] opacity-50 blur-lg animate-pulse"
          style={{ animationDuration: "2.4s" }}
        />
        {/* Expanding radar rings */}
        <span
          className="absolute -inset-1.5 rounded-full border border-[#8B5CF6]/50 animate-ping"
          style={{ animationDuration: "2.2s" }}
        />
        <span
          className="absolute -inset-3 rounded-full border border-[#8B5CF6]/25 animate-ping"
          style={{ animationDuration: "3s", animationDelay: "0.5s" }}
        />

        {/* Main orb */}
        <span className="relative w-14 h-14 rounded-full bg-gradient-to-br from-[#a78bfa] via-[#8B5CF6] to-[#6d28d9] shadow-lg shadow-[#8B5CF6]/50 flex items-center justify-center overflow-hidden ring-1 ring-white/20">
          {/* Hover shimmer sweep */}
          <span className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/30 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out" />
          <Sparkles className="w-6 h-6 text-white drop-shadow-sm" strokeWidth={2} />
        </span>

        {/* Online indicator */}
        <span className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 rounded-full bg-[#22C55E] border-2 border-white shadow-sm animate-pulse" style={{ animationDuration: "1.8s" }} />
      </button>
